...
from quanquant.web.deps import get_session, parse_date
...
def _filtered(session: Session, symbol, tag, date_from, date_to):
...
async def stats_page(
    ...
    _, closed = _filtered(session, symbol, tag, date_from, date_to)
...
async def export_csv(
    ...
    detail, _ = _filtered(session, symbol, tag, date_from, date_to)
    return Response(
...
async def export_xlsx(
    ...
    detail, closed = _filtered(session, symbol, tag, date_from, date_to)
    return Response(
